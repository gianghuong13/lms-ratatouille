...
CREATE TABLE users (
    user_id VARCHAR(8) PRIMARY KEY, -- 22026568/FIT10303/admin003
...
CREATE TABLE assignment_files (
    ...
    file_path VARCHAR(255) NOT NULL, -- Đường dẫn lưu trữ tệp tin
    upload_date DATETIME DEFAULT CURRENT_TIMESTAMP,
...
-- Tạo bảng post_files để lưu thông tin các tệp đính kèm bài đăng
...
-- Tạo bảng announcement_files để quản lý các tệp tin đính kèm thông báo
...
-- Tạo bảng announcement_classes để quản lý mối quan hệ giữa thông báo và các lớp
